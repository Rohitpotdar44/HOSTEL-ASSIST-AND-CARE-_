...
function showSignInForm() {
    document.getElementById('formContent').innerHTML = `
        <h1 style="font-size: var(--big-font-size); font-weight: 500; margin-bottom: 2rem;">New Student Registration</h1>
        ...
        <div style="position: relative; display: grid; grid-template-columns: 7% 93%; margin-bottom: 30px; padding: .25rem 0; border-bottom: 1px solid var(--text-color);">
            ...
            <div style="position: relative;">
                <label style="display: block; position: absolute; left: .75rem; top: .25rem; font-size: var(--normal-font-size); color: var(--text-color); transition: .3s;">Branch</label>
                <input type="text" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; outline: none; background: none; padding: .5rem .75rem; font-size: 1.2rem; color: var(--first-color); transition: .3s;">
            </div>
        </div>
        <div style="position: relative; display: grid; grid-template-columns: 7% 93%; margin-bottom: 30px; padding: .25rem 0; border-bottom: 1px solid var(--text-color);">
            ...
            <div style="position: relative;">
                <label style="display: block; position: absolute; left: .75rem; top: .25rem; font-size: var(--normal-font-size); color: var(--text-color); transition: .3s;">Year</label>
                <input type="text" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; outline: none; background: none; padding: .5rem .75rem; font-size: 1.2rem; color: var(--first-color); transition: .3s;">
            </div>
        </div>
        <div style="position: relative; display: grid; grid-template-columns: 7% 93%; margin-bottom: 30px; padding: .25rem 0; border-bottom: 1px solid var(--text-color);">
...
function showLoginForm() {
    document.getElementById('formContent').innerHTML = `
        ...
        <div style="position: relative; display: grid; grid-template-columns: 7% 93%; margin-bottom: 30px; padding: .25rem 0; border-bottom: 1px solid var(--text-color);">
            ...
            <div style="position: relative;">
                <label style="display: block; position: absolute; left: .75rem; top: .25rem; font-size: var(--normal-font-size); color: var(--text-color); transition: .3s;">Hostel ID</label>
                <input type="text" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none; outline: none; background: none; padding: .5rem .75rem; font-size: 1.2rem; color: var(--first-color); transition: .3s;">
            </div>
        </div>
